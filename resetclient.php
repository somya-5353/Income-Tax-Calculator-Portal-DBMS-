...
<head>
   ...
   <style>
    ...
    <div class="contain">
    <div id="head">
        <h5 id="add"><span class="add1">Income Tax Calculator ->  </span>Home | Client | Reset Password<span class="back"><a href="client1.php" class="link"><u>BACK</u></a></span></h5>
...
if(isset($_POST["submit"])){
    ...
    {   
        ...
        $password=mysqli_real_escape_string($link,$password);
         $sql="UPDATE client SET password='$password' where password='$name'";
...
?>
    ...
    <form action="resetclient.php" method="post">
     <br /> 
    ...
    <img src="images/exc.png" class="bodyimagey">
     <div class="msg2"></div>
    <div class="form-group">
        ...
        <input type="submit" name="submit" class="btn btn-success btn-lg" id="button1" value="RESET" style="background-color:#e8bd78;">
