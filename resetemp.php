...
<head>
   ...
   <style>
    ...
    <div class="contain">
    <div id="head">
        <h5 id="add"><span class="add1">Income Tax Calculator ->  </span>Home | Employee | Reset Password<span class="back"><a href="emp1.php" class="link"><u>BACK</u></a></span></h5>
...
if(isset($_POST["submit"])){
    ...
    {   
        ...
        $password=mysqli_real_escape_string($link,$password);
         $sql="UPDATE employee SET password='$password' where password='$name'";
...
?>
    ...
    <form action="resetemp.php" method="post">
     <br /> 
