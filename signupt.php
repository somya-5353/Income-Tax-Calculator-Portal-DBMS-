...
<body> 
    ...
    <div class="image1" id="image">
     <img src="images/sup.png" class="bodyimage1">
    </div> 
...
if(isset($_POST["submit"])){
    ...
    if(!$name){
        ...
        setcookie ("uname","$name",time()+6700); 
...
?>
    ...
    <form action="signupt.php" method="post">
     ...
     <img src="images/exc.png" class="bodyimagex">
     <div class="msg1"></div>
        <div class="form-group">
        ...
        <input type="submit" name="submit" class="btn btn-success btn-lg" id="button1" value="SIGN UP" color="black" style="background-color:#8d4f20;">
    ...
    $(function(){
        $(".bodyimagex").mouseover(function(){
            $(".msg1").html("<p id='er'>Password should be atleast 8 characters long,should begin with a lowercase alphabet and should contain atleast one digit</p>");
        });
